...
public class FareCalculateInnova extends OlaApp{
	public void finalfareCalculateInnova(String cab_name,double finalBillPrice,LocalDate date,LocalTime time) {
